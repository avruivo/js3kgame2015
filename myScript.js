            ...
            var Draw = {
                ...
                , uiElements: function (ctx, uiElementsList) {
                    for (var i in uiElementsList) {
                        ...
                        var allowedDirections = calcAllowedDirections(currElem);
             ...
             function calcAllowedDirections(element) {
                var casted = UiElement('', '', ''); //dummy
                casted = element;
                
                
                //check if can go down
                var newPosition = casted;
                newPosition.x += 0;
                newPosition.y += newPosition.vy;
...
//                 }
            ...
            function UiElement(x, y, eType) {
                ...
                return { "x": x, "y": y, "cType": eType, "length": GameCfg.uiElementsLength, "vx": vx, "vy": vy, "direction": null, "nextDirection": null };
            }
